...
This is the [me&u](https://www.meandu.com/) data platform status page.

You can find the general status of the underlying platforms (Snowflake and dbt) as well as the data freshness.
